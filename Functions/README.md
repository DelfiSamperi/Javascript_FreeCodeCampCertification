...
* __Global scope:__ This is the outermost scope in JavaScript. Variables declared in the global scope are accessible from anywhere in the code and are called global variables.
* __Local scope:__ This refers to variables declared within a function. These variables are only accessible within the function where they are declared and are called local variables.
* __Block scope:__ A block is a set of statements enclosed in curly braces {} such as in if statements, or loops.
